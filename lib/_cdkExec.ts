...
export async function _cdkExec(
  vorpal: Vorpal,
  somId: string,
  region: string,
...
export async function cdkList(
  ...
  return _cdkExec(vorpal, somId, region, params, plumbing, 'list');
}
...
export async function cdkSynth(
  ...
  return _cdkExec(vorpal, somId, region, params, plumbing, 'synth');
}
...
export async function cdkDiff(
  ...
  return _cdkExec(vorpal, somId, region, params, plumbing, 'diff');
}
...
export async function cdkDeploy(
  ...
  return _cdkExec(vorpal, somId, region, params, plumbing, 'deploy', stackName);
}
...
export async function cdkDestroy(
  ...
  if (!somId) return [1, []];
  return _cdkExec(vorpal, somId, region, params, plumbing, 'destroy', '--all', ['--force']);
}
